...
public class GrammaticalEvolution extends Algorithm<Variable<Integer>> {
  ...
  private static final boolean jecoPopulationMerge = false; //True si se quiere usar la forma de generar la nueva poblaci�n a partir de la nueva generacion y la antigua de jeco.
